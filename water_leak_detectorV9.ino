...
void setup() {
	...
	Serial.println(F("Version 11.0 (03/09/2023) Booting....."));
...
void loop() {
    ...
    //every 15 minutes print over serial the available system RAM and the system up-time in minutes and contact healthcheckio
    currentMillis = millis();
    if (currentMillis - free_ram_Millis >= 900000) { //every 15 mins print the current RAM availability and contact healthcheckio
